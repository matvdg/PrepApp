...
class HelpViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var helpTexts = [
        ...
        //Aide Entraînement
        "Orientez vos révisions en choisissant la matière et le chapitre que vous souhaitez. Si la solution de la question est incomprise, marquez la afin de faire part à vos professeurs de vos difficultés. Vous pouvez également retrouver les questions marquées dans la section profil afin de les retravailler. Appuyez sur \"Question\" et retrouvez les nouvelles questions, celle réussies, marquées ou échouées.",
        //Aide défi solo
        "Vous disposez de 20 minutes ? Grace au trigramme choisissez la matière, ou la combinaison de matières afin de créer le défi qui vous convient. Les questions du défi solo n’ont jamais été vues auparavant et basculent dans la section entrainement une fois le défi terminé.",
        //Aide défi duo
        "Vous disposez de 20 minutes ? Affrontez un ami et envoyez lui un défi. Il recevra une notification Prep’App et aura 24h pour répondre au défi. Vous pourrez ensuite comparer vos résultats et recevoir vos points. En plus des points gagnés par chacun, le vainqueur reçoit 10 KP (KeyPoints). Les questions du défi duo n’ont jamais été vues auparavant et basculent dans la section entrainement une fois le défi terminé. ",
        //Aide concours
        "Participez au concours Prep’App dans les mêmes conditions que le jour J. Cet événement est accessible pendant un certain temps déterminé par votre établissement. Les questions du concours n’ont jamais été vues auparavant dans aucun des autres modes et basculent dans la section entraînement une fois le concours terminé ou dans défi solo si vous n'avez pas participé au concours.",
        //Aide profil
        "Dans cette section, vous pouvez consulter vos statistiques, à votre classement, rajouter ou supprimer des amis pour le défi duo, consulter ou supprimer vos questions marquées et envoyer un commentaire au professeur, ou encore nous envoyer des suggestions ou des remarques pour l'app Prep'App. Dans statistiques, découvrez le concept ANP : Assiduité, niveau et performance sont les 3 critères qui valorisent votre progression. Votre assiduité représente le nombre de questions répondues quelles soient justes ou fausses tandis que votre niveau ne tient compte que de vos questions réussies. Votre performance est l’indice mesurant votre taux de réussite par rapport aux questions répondues et ce toutes les semaines. Les KeyPoints (KP) sont une combinaison de votre niveau et de votre assiduité. Dans les défis et les concours vous pourrez gagner des KP bonus. ",
        //Aide réglages
