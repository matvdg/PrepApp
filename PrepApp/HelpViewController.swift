...
class HelpViewController: UIViewController {
    ...
    var helpTexts = [
        ...
        //8- Aide classement
        "Situez-vous dans votre établissement avec notre classement Prep'App grâce aux AwardPoints.",
